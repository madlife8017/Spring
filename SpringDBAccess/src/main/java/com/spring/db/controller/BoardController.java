...
public class BoardController {
    ...
    public String content(int boardNo, Model model) {
    	System.out.println("상세보기 번호 : " + boardNo);
  ...
  //modify.jsp를 생성해서 form태그에 사용자가 처음에 작성했던 내용이 드러나도록
    ...
    public String modify(int boardNo, Model model) {
    	System.out.println("수정하기 번호 : " + boardNo);
    	model.addAttribute("article", service.getArticle(boardNo));
    	return "board/modify";
    }
    ...
    public String modify(BoardVO vo, Model model) {
    	System.out.println("수정처리하기" + vo);    	
    	service.updateArticle(vo);
    	model.addAttribute("article", service.getArticle(vo.getBoardNo()));
    	return "board/content";	
    }    
    ...
    @GetMapping("/delete")
    public String deleteArticle(int boardNo) {
    	System.out.println("삭제 번호 : " + boardNo);
